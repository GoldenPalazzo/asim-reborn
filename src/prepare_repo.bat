...
curl https://github.com/GoldenPalazzo/bare68k-python3.12/releases/download/v0.1.2-3.12/bare68k-0.1.2-cp312-cp312-win_amd64.whl -o lib\bare68k-0.1.2-cp312-cp312-win_amd64.whl 
dir bin
dir res
dir lib
